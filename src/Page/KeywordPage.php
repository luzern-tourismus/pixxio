...
use LuzernTourismus\Pixxio\Data\Keyword\KeywordReader;
...
class KeywordPage extends AbstractTemplateDocument
{
    public function getContent()
    {
        ...
        (new AdminTableHeader($table))
            ...
            ->addText($reader->model->keyword->label);
